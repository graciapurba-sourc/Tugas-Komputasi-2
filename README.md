...
Repositori ini berisi Tugas Mata Kuliah Komputasi Statistika.
Mengenai penjelasan Materi dari Mata Kuliah yang sudah dipelajari dan implementasinya dalam Kode R


## 👩🏻‍🏫 Isi Repositori

- **Kumpulan Kode R**: Script (`.R`) dan R Markdown (`.Rmd`) yang digunakan untuk tugas seperti (vector, array, data frame, dan list) di kelas.
